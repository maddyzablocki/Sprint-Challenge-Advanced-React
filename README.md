...
With class components you can have life cycle methods
- [x] Name three lifecycle methods and their purposes.
ComponentDidMount: This happens when it first renders, it is in the birth/mounting phase.
ComponentDidUpdate: It performs actions when the state changes, it takes two arguments, prevProps and prevState
ComponentDidUnmount: This is used in the Death/unmounting phase. It is used for any clean up that needs to be done
- [x] What is the purpose of a custom hook?
Custom hooks are dynamic and reusable, so you don't have to keep writing out the same code
- [x] Why is it important to test our apps?
It is important to test our apps so we can be confident in our code, and it catches any errors we missed when manually testing.
